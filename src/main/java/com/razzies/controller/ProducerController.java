...
public class ProducerController {
	...
	public ResponseEntity<ProducerResponse> obterProducers() {
		...
		try {
			final List<ProducerWinner> max = producerService.getProducersByRankingType(RankingType.MAX);
			final List<ProducerWinner> min = producerService.getProducersByRankingType(RankingType.MIN);
